...
export default function TechnologyCard({title, image, description, rating}: Technology) {
  return <article className="m-2 p-2 bg-white rounded">
      ...
      ></Image>
      <p>{description}</p>
      <p className="flex justify-center text-green-700"><b>Avaliação: {rating.rate}</b></p>
      <p className="flex justify-center text-green-700"><b>Usado por {rating.count} pessoas</b></p>
      </article>
}